...
const HeroBanner = () => {
  return (
    ...
    ml:{sm :'50px' }
        ...
        <Button variant='contained' href = "#exercises" color='error' mb="40px" xs={{backgroundColor:"#ff2625", padding:"10px"}}>Explore Exercises</Button>
        <Typography fontWeight={600} color="#ff2625" sx={{opacity :0.1,
        display:{lg:'block', xs: 'none'}}}
        fontSize="200px" mt="30px">Exercise</Typography>
